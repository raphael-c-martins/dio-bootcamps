...
-- 1. Tabela de ColeÃ§Ãµes (Tabela Dominial / Pai)
...
-- 2. Tabela de Tipos de PokÃ©mon (ex: Grass, Fire, Water, Electric, etc.)
CREATE TABLE IF NOT EXISTS tbl_types (
    id SERIAL PRIMARY KEY,
    name VARCHAR(50) NOT NULL UNIQUE
);

-- 3. Tabela de EstÃ¡gios da Carta (ex: Basic, Stage 1, Stage 2, VMAX, VSTAR, EX)
...
CREATE TABLE IF NOT EXISTS tbl_cards (
    ...
    -- RestriÃ§Ã£o de Unicidade: Evita duplicaÃ§Ã£o do mesmo nÃºmero de carta na mesma coleÃ§Ã£o
...
-- Ãndices de Alta Performance para busca e filtros relacionais
